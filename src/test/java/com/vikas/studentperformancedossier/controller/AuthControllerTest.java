...
class AuthControllerTest {
    ...
    void register_whenValid_returns201() throws Exception {
        RegisterRequest request = new RegisterRequest("ada", "password123", Role.TEACHER);
        when(authService.register(eq(request))).thenReturn(sampleUserResponse());
    ...
    void register_whenUsernameBlank_returns400() throws Exception {
        RegisterRequest invalidRequest = new RegisterRequest("", "password123", Role.TEACHER);
    ...
    void register_whenPasswordTooShort_returns400() throws Exception {
        RegisterRequest invalidRequest = new RegisterRequest("ada", "short", Role.TEACHER);
    ...
    void register_whenRoleMissing_returns400() throws Exception {
        RegisterRequest invalidRequest = new RegisterRequest("ada", "password123", null);
